...
{
	unsigned int i = 0;					/* haystack loop counter */
	unsigned int j = 0;					/* needle loop counter */
	unsigned int len1 = 0;				/* haystack length */
	unsigned int len2 = 0;				/* needle llength */
	unsigned int k = 0;					/* count from start of instance */
